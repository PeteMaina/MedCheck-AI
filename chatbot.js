        ...
        const response = await fetch('http://localhost:1234/v1/chat/completions', {
                ...
                model: "mistral-7b-instruct-v0.2.Q4_K_M",
                    messages: [
                        {
                            role: "system",
                        content: "You are an AI medical assistant. You help analyze symptoms and provide general medical information. Ask many questions to narrow down to the specific ailment. Always remind users to consult healthcare professionals for deeper complex medical advice. Be empathetic and thorough in your responses. space your response with 2 new lines."
                        },
                        {
                            role: "user",
                        content: userMessage
